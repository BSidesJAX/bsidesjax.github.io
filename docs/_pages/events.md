...
<table style="width:100%; border-style:solid; border-color:#ABB2B9; border-width:thin; border-radius: 8px;">
    ...
    <tr>
        <td style="vertical-align:top;"><img src="../assets/images/redmagesec_flame.png" alt="#" width="500" height="700"></td>
        <td>
    ...
    <tr>
        <td style="vertical-align:top;"><img src="../assets/images/foxpick.jpg" alt="#" width="500" height="700"></td>
        <td>
    ...
    <tr>
        <td style="vertical-align:top;"><img src="#" alt="../assets/images/header-web.jpg" width="500" height="700"></td><!-- TODO: Get HHV Pic-->
        <td>
    ...
    <tr>
        <td style="vertical-align:top;"><img src="../assets/images/wvillage.png" alt="#" width="500" height="700"></td>
        <td>
