...
The code will be availble in the CTF room, at the event on November 15th.

#### 8. Can I get proof of attendance for the conference for continuing education credits (CPE)?

Yes. You will need to print the following form and get it signed by a member of the conference staff.
<a href="../assets/files/bsidesjax-cpe-form.pdf" target="_blank">Proof of Attendance Form</a>